        ...
        <div class="container-fluid">
            <div class="row vh-100">
                <div class="col-md-6 text-center py-5 d-flex flex-column justify-content-center auth-bg-section text-white" style="background-image: url(https://www.bootstrapdash.com/demo/unplug-ui-kit-pro/demo/assets/images/login-bg.jpg)">
                    ...
                    <h1 class="text-reset">Welcome to <br> Register Page</h1>
                ...
                <div class="col-md-6 text-center d-flex flex-column py-5 justify-content-center">
                    <div class="auth-form-section">
                        ...
                        <h2>Sign Up</h2>
                        <p>Welcome To Register Page Master :)</p>
                        <form class="auth-form" method="POST" action="{{ route('register') }}">
                            @csrf
                            <div class="form-group">
                                <label for="Name" class="sr-only">Name</label>
                                <input type="text" name="name" id="Name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" required autocomplete="name" autofocus placeholder="Name">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="email" placeholder="Email">
                             ...
                             <div class="form-group">
                                ...
                                <input type="password" name="password" id="password" class="form-control @error('password') is-invalid @enderror" value="{{ old('email') }}" required autocomplete="new-password" placeholder="Password">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                <a class="btn btn-secondary btn-block mb-3" href="{{route('login')}}">Login</a>
                            </div>
                            </div>
